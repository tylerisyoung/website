...
14m Read: [Modern Monetary Theory - Slow at first, then all at once.](./mmt.html)  
</center>
<br>  
...
***How QE is hiding the debt spiral without free market price discovery.***


![](./Journalism/Economics/macro.png)
The combination of (Federal Budget Deficit + 10-Year Treasury Yield) shows The deficit  measured in dollars (currently around -$1.8T annually), and the 10 year yield as a percentage (currently ~4.5%) added into one line. 

Free market economics dictates that this line should be mean reverting to $0. To achieve this, as we have in the past, free market discovery of bond yields is necessary, but this trend will continue and reach -$3Trillion again and extend lower as the spiral continues.  

What the trend means - The deficit is so large that even with QE artificially capping yields at 4-5% (implied Yield Curve Control) the combined picture is still deeply negative, our borrowing hole is bigger than what reasonable rate normalization can offset. 

What you'd expect (normal economics - leading into the dot com bubble when we had a slight budget surplus) When the government runs bigger deficits, it has to borrow more. More borrowing means more bond supply - bond prices fall - yields rise. Bigger deficits should mean higher interest rates to close the gap and the chart goes above 0 indicating free market risk in US Treasuries (UST).

QE changes that.

Since the 80s, deficits have grown almost continuously, but the 10-year yield went from ~15% down to nearly 0% instead of up. That's the paradox of QE hiding the debt spiral. When long term treasury yields began to rise too rapidly, the Fed began to buy treasuries (Quantitative Easing) masking price discovery for government debt, and until recently, global demand for UST's as a safe reserve asset held steady too helping keep prices high and yields low despite ballooning supply, but relief is temporary and the fun is over. 

Deficits are too high, liabilities exceed receipts, M2 and inflation will remain elevated to fund everything, and demand for UST's will dry up in a multipolar commodity driven world. 
...
***If you're not confused, you're lying! High Oil and a semi-permeable strait lead straight to Multipolarity, AI is priced in, and BTC as the liquid macro signal.***

Equity breadth is unexpectedly at multi year highs. The top stocks are carrying the team, but everything else is catching up after lagging for a decade. Does this mark a healthy and recovering trend, or is this an anomaly as EVERYTHING else is in a macro downtrend including GDP, retail sales, the jobs report, payrolls, openings, consumer confidence, and more while inflation remains sticky. But as bubble discussions reach the mainstream, as the hyperscalers reach peak hype and the capex loop slows down, the tide at the top is now turning too. As breadth declines and as the MAG 7 reach PE ratios that can never be justified, both breadth as well as the high flyers may decline at the same time. 
![](./Journalism/Economics/ongoingta/5-20-2026_4.png)
![](./Journalism/Economics/ongoingta/5-20-2026_2.png)

US Govt debt interest payments and entitlements are above income tax and foreign receipts kicking off the debt spiral. The circle is higher interest rates, stronger dollar, slower growth, lower rates, more printing, higher inflation, weaker growth. But we can only kick this can down the road for so long before foreign nations loose interest in the strength of our treasuries and willingness to trade without a re-pricing of trade balances the the US. Inch by inch we move closer to a multipolar world. 

The Iranians operating a taxable closure on the Strait of Hormuz while pricing some percentage of oil in Yuan only accelerates the shift away from USD which will mean more inflation, and by necessity a re-pricing of Gold as a reserve currency at least 3X, and more likely 5-8X higher than it is now even in relation to already high oil. 
![](./Journalism/Economics/ongoingta/5-20-2026_5.png)
This is the macro that is happening now, and why stocks remain elevated is beyond me. There is a very good chance that we have passed the peak as measured in Gold or Oil for the MAG 7. We have two massive companies that have announced IPO's this year - OpenAI ($850Bn) and SpaceX ($1.75Trillion). 

The market cannot just absorb $2Trillion of new funds into being among the top ten companies on the planet while maintaining the current market caps of (NVDA) $5.41 Trillion (GOOG) $4.66 Trillion (AAPL): $4.44 Trillion (MSFT) $3.13 Trillion (AMZN) $2.85 Trillion (TSLA) $1.57 Trillion (META) $1.54 Trillion

Total Mag 7 Market Cap: ~$23.6 Trillion

The market has finished pricing in the AI hype, and is now officially a bubble. Former Open AI employee Leopold Aschenbrenner who was ousted from the company and started his own AI investment firm recently took out an 8Bn short position against the heavy hitters in the AI space, and only remains long on datacenter buildout companies, physical contractors, and BTC miners who are pivoting. His book includes: 
...
![](./Journalism/Economics/ongoingta/5-20-2026_3.png)

I believe the time between now and the IPO of OpenAI marks a durable top that will last until at least the end of the business cycle. 

Rates will need to come all the way down, commodities will continue to have their day, the dollar will yield, and for at least a couple years, things will be slow. Only after these things happen will the market have a recovery, only next time we will be looking at some definitively different players. 

BTC as the ever present macro signal has just been rejected by the 200DSMA, suggesting at least another six months of winter and weakness through the end of the year. We will see what comes.  

![](./Journalism/Economics/ongoingta/5-20-2026_1.png)
...
![](./Journalism/Economics/ongoingta/5-19-2025_6.png)
...
![](./Journalism/Economics/ongoingta/5-19-2025_1.png)
...
Despite this, the current president, love him or hate him has proposed an increase to the federal deficit within his ["One Big Beautiful Bill".](https://time.com/7286837/what-trumps-big-beautiful-bill-would-do-to-the-national-debt/) 



![](./Journalism/Economics/ongoingta/5-19-2025_2.png)
...
![](./Journalism/Economics/ongoingta/5-19-2025_3.png)
...
![](./Journalism/Economics/ongoingta/5-19-2025_4.png)
![](./Journalism/Economics/ongoingta/5-19-2025_5.png)
