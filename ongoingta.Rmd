...
The Iranians operating a taxable closure on the Straight of Hormuz while pricing some percentage of oil in Yuan only accelerates the shift away from USD which will mean more inflation, and by necessity a re-pricing of Gold as a reserve currency at least 3X higher than it is now in relation to already high oil. 

This is the macro that is happening now, and why stocks remain elevated is beyond me. Breadth is at historic lows which does make sense, but there is also a very good chance that this is the top for the MAG 7. We have two massive companies that have announced IPO's this year - OpenAI ($850Bn) and SpaceX ($1.75Trillion). 
