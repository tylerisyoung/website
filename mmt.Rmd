...
The current running US annual spending is $6.1T while total tax revenue is $4.2T, leaving us with a budget deficit of $1.9T. The largest budget expenditures are Medicare & Medicaid ($1.3T), Social Security ($1.2T), Defense Spending ($730B), and Net Interest on the debt itself ($430B). 
